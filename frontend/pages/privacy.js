...
const privacy = () => {
  ...
  <p>
    ...
    <a href="https://blog.hassanjr.com">blog.hassanjr.com</a> website
    (“Website”), “Noma” mobile application (“Mobile Application”), and any of
    their related products and services (collectively, “Services”), and our
  ...
  <p>
    ...
    the authority to bind such entity to this agreement, in which case the terms
    ...
    not accept this agreement and may not access and use the Services. By
  ...
  <p>
    ...
    never to provide Personal Information through the Services without their
    permission. We also ask that all parents and legal guardians overseeing the
    care of children take the necessary precautions to ensure that their
  ...
  <p>
    ...
    you in which case you would be the data controller and we would be the data
    processor.
  </p>
  <p>
    ...
    ask you to submit your Personal Information that is necessary to ensure your
    access and use of the Services. In such instances, we are a data controller
  ...
  <p>
    ...
    Personal Information through the Services. We do not own, control, or make
    decisions about the submitted Personal Information, and such Personal
  ...
  <p>
    ...
    agreement with you and/or for any pre-contractual obligations thereof; (iii)
    processing is necessary for compliance with a legal obligation to which you
    are subject; (iv) processing is related to a task that is carried out in the
  ...
  <p>
    ...
    until you object to such processing by opting out, without having to rely on
    consent or any other of the legal bases. In any case, we will be happy to
  ...
  <p>
    ...
    Services are not yet set up to interpret or respond to Do Not Track signals
    ...
    Information. For a description of Do Not Track protocols for browsers and
  ...
  <p>
    ...
    disclosure of Personal Information in our control and custody. However, no
  ...
  <p>
    ...
    in other ways at our discretion, such as through the contact information you
    have provided.
  </p>
  <p>
    ...
    of the Services after the effective date of the revised Policy (or such
  ...
  <p>
    ...
    information you agree to be bound by this Policy. If you do not agree to
    abide by the terms of this Policy, you are not authorized to access or use
    the Services. This privacy policy was created with the help of{" "}
  ...
  <p>
    ...
    effort to honor your wish to exercise your rights as quickly as possible and
